...
userrouter.post('/send-otp', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        }, process.env.JWT_SECRET || "", { expiresIn: '5m' } // Short expiration for OTP
        );
        return res.json(Object.assign({ success: true, message: process.env.NODE_ENV === 'production' ?
                'OTP sent successfully' :
                `DEV: OTP is ${otp}`, token, userId: user.id }, (process.env.NODE_ENV !== 'production' && { otp })));
    }
    catch (error) {
        console.error('OTP sending failed:', error);
        return res.status(500).json(Object.assign({ success: false, error: 'Failed to process OTP request' }, (process.env.NODE_ENV === 'development' && {
            details: error
        })));
    }
}));
userrouter.get('/checkPromo', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
...
userrouter.post('/addpurchase', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const exist = yield prisma.purchase.findUnique({
            where: {
...
userrouter.get('/IsPayVerified', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const access = yield prisma.purchase.findMany({
            where: {
                number: number
            },
            select: {
...
userrouter.delete('/removelastLink', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
userrouter.get('/getall', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const all = yield prisma.user.findMany({});
    return res.json({
        all
    });
}));
